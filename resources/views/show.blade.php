        ...
        <div class="flex items-center ml-6 space-x-4">
            <div x-data="{ isOpen: false }" class="relative">
                ...
                <div class="absolute z-10 mt-2 text-sm font-semibold text-left bg-white w-104 shadow-dialog rounded-xl"
                    x-show="isOpen" @click.away="isOpen = false" @keydown.escape.window="isOpen = false" x-cloak
                    x-transition.duration.200ms>
            ...
            <div x-data="{ isOpen: false }" class="relative">
                ...
                <div x-show="isOpen" x-transition.duration.200ms @click.away="isOpen = false"
                    @keydown.escape.window="isOpen = false" x-cloak
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div x-data="{ isOpen: false }" class="flex items-center space-x-2">
                            <button @click="isOpen = !isOpen"
                                ...
                                <ul x-show="isOpen" x-transition.duration.200ms @click.away="isOpen = false"
                                    @keydown.escape.window="isOpen = false" x-cloak
                                    class="absolute z-10 py-3 ml-8 font-semibold text-left bg-white w-44 shadow-dialog rounded-xl">
                                    <li>
                                        <a href="#"
