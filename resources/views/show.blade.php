                    ...
                    <form action="#" class="px-4 py-6 space-y-4">
                        <div>
                            <textarea name="post_comment" id="post_comment" cols="30" rows="4"
                                class="w-full px-4 py-2 text-sm placeholder-gray-500 bg-gray-100 border-none rounded-xl"
            ...
            <div class="relative">
                ...
                <div class="absolute z-20 mt-2 text-sm font-semibold text-left bg-white w-76 shadow-dialog rounded-xl">
                    <form action="#" class="px-4 py-6 space-y-4">
                        ...
                        <div>
                            <textarea name="update_comment" id="update_comments" cols="30" rows="3" class="w-full px-4 py-2 text-sm placeholder-gray-500 bg-gray-100 border-none rounded-xl" placeholder="Add an update comment (optional)"></textarea>
                        </div>
