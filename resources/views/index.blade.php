<x-app-layout>
    <div class="flex space-x-6 filters">
        <div class="w-1/3">
            <select name="category" id="category" class='w-full px-4 py-2 border-none rounded-xl'>
                <option value="all">Category 11</option>
                <option value="all">Category 21</option>
                <option value="all">Category 31</option>
                <option value="all">Category 41</option>
            </select>
        </div>
        <div class="w-1/3">
    ...
    <div class="my-6 space-y-6 ideas-container">
        <div
            class="flex transition duration-150 ease-in bg-white border border-gray-100 cursor-pointer idea-container hover:shadow-card rounded-xl">
            ...
            <div class="flex flex-1 px-2 py-6">
                ...
                <div class="w-full mx-4">
                    <h4 class="text-xl font-semibold">
                        <a href="/idea" class="hover:underline">A random title can go here</a>
                    </h4>
        ...
        <div
            ...
            <div class="flex px-2 py-6">
                <a href="#" class="flex-none">
                    <img src="https://randomuser.me/api/portraits/men/14.jpg" alt="avatar"
                        class="w-14 h-14 rounded-xl">
                </a>
                <div class="mx-4">
                    <h4 class="text-xl font-semibold">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            <div
                                class="px-4 py-2 font-bold leading-none text-center text-white uppercase rounded-full bg-yellow text-xxs w-28 h-7">
                                In Progress</div>
                            <button
            ...
            <div class="flex px-2 py-6">
                ...
                <div class="mx-4">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            <div
                                class="px-4 py-2 font-bold leading-none text-center text-white uppercase rounded-full bg-red text-xxs w-28 h-7">
                                Closed</div>
                            <button
                                class="relative px-3 py-2 transition duration-150 ease-in bg-gray-100 rounded-full hover:bg-gray-200 h-7">
                                <svg fill="currentColor" width="24" height="6">
        ...
        <div
            ...
            <div class="flex px-2 py-6">
                <a href="#" class="flex-none">
                    <img src="https://randomuser.me/api/portraits/women/13.jpg" alt="avatar"
                        class="w-14 h-14 rounded-xl">
                </a>
                <div class="mx-4">
                    <h4 class="text-xl font-semibold">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            <div
                                class="px-4 py-2 font-bold leading-none text-center text-white uppercase rounded-full bg-purple text-xxs w-28 h-7">
                                Considering</div>
                            <button
                                class="relative px-3 py-2 transition duration-150 ease-in bg-gray-100 rounded-full hover:bg-gray-200 h-7">
                                <svg fill="currentColor" width="24" height="6">
