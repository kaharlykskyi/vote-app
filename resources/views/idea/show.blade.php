            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="flex flex-col justify-between mt-6 md:flex-row md:items-center">
                    ...
                    <div
                        ...
                        x-data="{ isOpen: false }"
                    >
                        <div class="{{ Str::kebab('status' . $idea->status->name) }} px-4 py-2 font-bold leading-none text-center uppercase rounded-full text-xxs w-28 h-7">
                            {{ $idea->status->name }}
                        </div>
                        <button
            ...
            >
                ...
                >
                    <form action="#" class="px-4 py-6 space-y-4">
                        <div>
                            <textarea name="post_comment" id="post_comment" cols="30" rows="4" class="w-full px-4 py-2 text-sm placeholder-gray-500 bg-gray-100 border border-gray-200 rounded-xl" placeholder="Go ahead, don't be shy. Share your thoughts..."></textarea>
                        </div>
            ...
            >
                ...
                >
                    <form action="#" class="px-4 py-6 space-y-4">
                        ...
                        <div>
                            <textarea name="update_comment" id="update_comments" cols="30" rows="3" class="w-full px-4 py-2 text-sm placeholder-gray-500 bg-gray-100 border border-gray-200 rounded-xl" placeholder="Add an update comment (optional)"></textarea>
                        </div>
    ...
    <div class="relative pt-4 my-8 mt-1 space-y-6 comments-container md:ml-22">
        <div class="relative flex mt-4 bg-white comment-container rounded-xl">
            <div class="flex flex-col flex-1 px-4 py-6 md:flex-row">
                <div class="flex-none">
                    <a href="#">
                        <img src="https://randomuser.me/api/portraits/women/6.jpg" alt="avatar" class="w-14 h-14 rounded-xl">
                    </a>
                </div>
        ...
        <div class="relative flex mt-4 bg-white comment-container rounded-xl">
            <div class="flex flex-col flex-1 px-4 py-6 md:flex-row">
                <div class="flex-none">
                    <a href="#">
                        <img src="https://randomuser.me/api/portraits/women/33.jpg" alt="avatar" class="w-14 h-14 rounded-xl">
                    </a>
                </div>
                <div class="w-full md:mx-4">
                    {{-- <h4 class="text-xl font-semibold">
        ...
        {{-- <div class="relative flex mt-4 bg-white is-admin comment-container rounded-xl">
            <div class="flex flex-1 px-4 py-6">
                <div class="flex-none">
                    <a href="#">
                        <img src="https://randomuser.me/api/portraits/women/67.jpg" alt="avatar" class="w-14 h-14 rounded-xl">
                    </a>
