        ...
        <form wire:submit.prevent='setStatus' action="#" class="px-4 py-6 space-y-4">
            <div class="space-y-2">
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model='status' type="radio" class="text-gray-600 bg-gray-200 border-none" name="status"
                            value="1" checked>
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model='status' type="radio" class="bg-gray-200 border-none text-purple" name="status"
                            value="2">
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model='status' type="radio" class="bg-gray-200 border-none text-yellow" name="status"
                            value="3">
            ...
            <div>
                <textarea name="update_comment" id="update_comments" cols="30" rows="3"
                    class="w-full px-4 py-2 text-sm placeholder-gray-500 bg-gray-100 border border-gray-200 rounded-xl"
            ...
            <div>
                <label wire:model='notifyAllVotes' class="inline-flex items-center font-normal">
                    <input type="checkbox" name="notify_voters" class="bg-gray-200 rounded">
