...
>
    <div class="flex items-end justify-center min-h-screen">
        ...
        <div x-show="isOpen" x-transition.origin.bottom.duration.300ms.ease-in-out
            ...
            <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                ...
                <p class="px-6 mt-4 text-xs leading-5 text-center text-gray-500">You have one hour to edit your idea
                    ...
                    <div>
                        <select wire:model.defer="category" name="category_add" id="category_add"
                            ...
                            @foreach ($categories as $category)
                                <option
                                    value="{{ $category->id }}"
                                    @if ($category->name == $idea->category->name) selected @endif
