<div
    wire:poll.visible='getNotificationCount'
    x-data="{ isOpen: false }"
    class="relative"
 >
    <button @click=
    ...
    ">
        <svg
            class="w-8 h-8 text-gray-400 transition duration-300 ease-out hover:text-blue"
            viewBox="0 0 20 20"
            fill="currentColor"
            :class="{ 'text-blue': isOpen, 'text-gray-400': !isOpen }"
        >
